        ...
        <div className="blog-posts page-width">
          {posts
            ...
            .map(({ node: post }, index) => {
              ...
              if(index > 1 && (index) % 7 ===  0) {ShowCard = <script async type="text/javascript" src="//cdn.carbonads.com/carbon.js?serve=CE7ITK7W&placement=jackharnercom" id="_carbonads_js"></script>}
              return (
                <>
