...
export default class ShareLinks extends Component{ 
    ...
    render(){
        ...
        let postImage = "https://jackharner.com" + (this.post.frontmatter.featuredImage ? this.post.frontmatter.featuredImage.childImageSharp.gatsbyImageData.images.fallback.src : defaultOGImage)
        return(
