...
const MainMenu = (props) => {
    ...
    return (<>
        <nav className={"main_nav" + (isOpen ? " is-open" : "")}>
            ...
            <SubMenu link={{ link: "/services", text: "Services" }} links={[{ link: "/services/shopify", text: "Shopify", icon: ['fab', 'shopify'] }, { link: "/services/bigcommerce", text: "BigCommerce", icon: "shopping-cart" }, { link: "/services/wordpress", text: "WordPress", icon: ["fa-brands", "wordpress"] }, { link: "/services/ghost-coding", text: "Ghost Coding", icon: "fa-ghost" }]} subMenuOpen={subMenuOpen} setSubMenuOpen={setSubMenuOpen} />
