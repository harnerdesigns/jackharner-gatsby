...
The <code>date.php</code> file is pretty similar to the other archival templates, it just allows you to specify a different archive page when looking at a specific date. You could also build a day.php, month.php, or year.php if you needed to be that specific in your archives
...
## <a href="https://github.com/harnerdesigns/blank2">BlanBlank WordPress Theme</a></h2>
